    ...
    <div class="container py-24">
        ...
        <div class="flex justify-center">
            <form method="POST" action="{{ route('login') }}">
                ...
                <button type="submit" class="bg-sky-500 font-bold w-full cursor-pointer p-2 rounded text-white">Accedi</button>
                <div class="flex justify-center mt-7">
                    <div class="flex flex-col">
                        <p>Non hai un account?</p>
                        <a class="text-center hover:underline text-sky-500" href="{{ route('register') }}">Registrati</a>
                    </div>
                </div>
            </form>
        </div>
