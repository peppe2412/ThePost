    ...
    <div class="container mt-24 flex justify-center">
        <div class="w-[50%] shadow-lg rounded-b-lg">
            <div class="bg-gray-100 rounded-t-lg p-2 mb-10">
                <h1 class="text-center text-2xl uppercase font-bold">Invia la richiesta per resettare la password</h1>
            </div>
                    ...
                    <div class="grid grid-cols-1 w-[50%]">
                        <div class="mb-5">
                            <input placeholder="Inserisci la tua email" name="email" type="email" id="email"
                                value="{{ old('email') }}" class="tw-form-input-auth-reset-password" />
                        </div>
